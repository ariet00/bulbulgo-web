...
/// Пресеты повторяют запасную палитру приложения (_fallbackHues в
/// service_card.dart) — значения синхронизированы вручную, одинаковый цвет
/// между Dart и TS не выводится автоматически.
const PRESETS = [
    '#2F6FD0',
    '#2E9E63',
    '#D8722C',
