...
const FLAGS: { key: FlagKey; title: string; description: ReactNode }[] = [
    ...
    },
    {
        ...
        title: 'Требовать подтверждённый номер',
        description: (
            <>
                <code>require_verified_phone</code>. Требует подтверждённый по
                SMS номер, чтобы публиковать поездки и смотреть контакты.
                Переопределяется для отдельного пользователя на его странице.
            </>
        ),
    },
    {
