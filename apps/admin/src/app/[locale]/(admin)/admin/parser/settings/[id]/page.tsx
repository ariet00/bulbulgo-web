...
import { useParserSetting, useUpdateParserSetting } from '@doska/shared'
...
export default function EditParserSettingPage() {
    const router = useRouter()
    const params = useParams<{ id: string }>()
    const settingId = Number(params.id)

    const { data: row, isLoading } = useParserSetting(settingId)
    const update = useUpdateParserSetting()
