...
import { useQuery } from '@doska/shared';
import { getRegions } from '@doska/shared';
import {
    Select,
    SelectContent,
    SelectItem,
...
import { useRouter, usePathname } from '@doska/i18n';
import { useRegionStore } from '@doska/shared';
