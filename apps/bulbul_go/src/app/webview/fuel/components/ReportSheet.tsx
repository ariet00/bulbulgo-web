                    ...
                    {priceAllowed && (
                        <Field label="Цена, сом/л (необязательно)">
                            <input
                                ...
                                className="w-full rounded-xl border border-border bg-card px-3 py-2.5 text-[14px] outline-none placeholder:text-muted-foreground/60 focus:border-[var(--wv-accent-border)]"
                            />
                        </Field>
                    )}
