...
// Кнопки «открыть в приложении»/сторы. Автоперехода нет — на странице есть
// контент-превью; Android-кнопка идёт intent-URL (приложение, если
// установлено, иначе Play Store). Путь /real_estate/details/:id — нативный
// App Link, iOS/Android с приложением открывают его сразу в приложении.
const PLAY_URL =
...
export default function OpenAppClient({ id }: { id: string }) {
    ...
    const androidIntent =
        `intent://go.bulbul.asia/real_estate/details/${id}` +
