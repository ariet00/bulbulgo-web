...
// Динамическая OG-картинка объявления: фото объекта на всю площадь + плашка с
// ценой/заголовком; без фото — брендовый градиент. Шрифты общие (_og/).
export const alt = 'Объявление в разделе Недвижимость BulBul Go'
